...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        operations.calculateWithIterator(productList, abiProductList);  // TODO:  1.
//        operations.calculateWithForLoop(productList, abiProductList); //:TODO 2.
//        operations.calculateStream(productList, abiProductList); //:TODO 3.
//        operations.calculateWithParallelStream(productList, abiProductList); //:TODO  4.
